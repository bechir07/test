                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-edit"></i> Forms <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    ...
                                    <li><a href="<?php echo curPageURL() ?>/views/admin/form_validation.php">Form Validation</a></li>
                            ...
                            <li><a><i class="fa fa-table"></i> Tables <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo curPageURL() ?>/views/admin/tables.php">Tables</a></li>
                                    <li><a href="<?php echo curPageURL() ?>/views/admin/tablesLivraisons.php">Table Dynamic</a></li>
                                </ul>
                            </li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                               aria-expanded="false">
                                <img src="<?php echo curPageURL() ?>/assets/back/images/img.jpg" alt=""><?PHP echo $_SESSION['name']; ?>
