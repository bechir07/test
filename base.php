...
<head>
    ...
    <link rel="stylesheet" href="<?php echo curPageURL() ?>/assets/front/css/style.css">
                ...
                <div class="user-menu">
                    <ul>
						...
						if ( Config::getUserSession() == null ) {
							echo '<li><a href="' . curPageURL() . '/views/signup.php"><i class="fa fa-user"></i> SignUp</a></li>';
							echo '<li><a href="' . curPageURL() . '/views/login.php"><i class="fa fa-user"></i> Login</a></li>';
						} else {
							echo '<li><a href="' . curPageURL() . '/views/profile"><i class="fa fa-user"></i> My Account</a></li>';
							echo '<li><a href="' . curPageURL() . '/views/logout.php"><i class="fa fa-user"></i> logout</a></li>';
						}
						?>
                    </ul>
                </div>
        ...
        <div class="row">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="<?php echo curPageURL() ?>">Home</a></li>
                    <li><a href="shop.html">Shop page</a></li>
                    <li><a href="single-product.html">Single product</a></li>
                    <li><a href="cart.html">Cart</a></li>
                    <li><a href="<?php echo curPageURL() ?>/views/profile/checkout.php">Checkout</a></li>
                    <li><a href="<?php echo curPageURL() ?>/views/profile/afficheLivraison.php">Display</a></li>
                    <li><a href="<?php echo curPageURL() ?>/views/profile/modifierL.php">Edit</a></li>
                    <li><a href="<?php echo curPageURL() ?>/views/profile/reclamation.php">Reclamer</a></li>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-about-us">
                    ...
                    <div class="footer-social">
                        <a href="https://www.facebook.com/esprit.tn/" target="_blank"><i class="fa fa-facebook"></i></a>
                        <a href="https://twitter.com/" target="_blank"><i class="fa fa-twitter"></i></a>
                        <a href="https://www.youtube.com/channel/UCJ5wuQ9AQYtpf9Arieu3iXA/feed" target="_blank"><i class="fa fa-youtube"></i></a>
...
<!-- Latest jQuery form server -->
    ...
    <script src="<?php echo curPageURL() ?>/assets/front/js/livraison.js"></script>
