        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="single-sidebar">
                        <h2 class="sidebar-title">Recemment pulbiés</h2>
                        <ul>
                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            <div class="woocommerce-info">Returning customer? <a class="showlogin" data-toggle="collapse" href="#login-form-wrap" aria-expanded="false" aria-controls="login-form-wrap">Cliquer ici pour se connecter</a>
                            </div>
                            ...
                            <form enctype="multipart/form-data" class="checkout" method="POST" name="checkout" action="<?php echo curPageURL() ?>/views/ajoutLivraison.php">
                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                ...
                                                <input type="text" value="" placeholder="Entrer votre nom" id="billing_first_name" name="nom" class="input-text ">
                                            </p>

                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="" for="billing_last_name">Last Name <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="" placeholder="Entrer votre prenom"  id="billing_last_name" name="prenom" class="input-text ">
                                            </p>
                                            <div class="clear"></div>

                                            <p id="billing_id_field" class="form-row form-row-wide">
                                                <label class="" for="billing_id">id</label>
                                                <input type="text" value="" placeholder="Entrer le nom du campagne" name="idd" class="input-text ">
                                            </p>-->
