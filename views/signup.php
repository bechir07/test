	...
	if(isset($email) && isset($password)){
		...
		if($result == null)
			...
			header('Location: profile/checkout.php');
		}
	}
}
?>
		...
		<div class="col-md-12" style="text-align: center">
			...
			<form class="form-login" action="signup.php"  method="post">
                ...
                <div class="form-group">
                    ...
                    <input  required="required" name="id" type="text" class="form-control" placeholder="Your id *" value="" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input  required="required" name="role" type="text" class="form-control" placeholder="Your role *" value="" />
				</div>
                <div class="form-group">
